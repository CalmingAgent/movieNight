...
from movieNight.settings import ICON, ACCENT_COLOR
from movieNight.utils import make_number_pixmap, open_url_host_browser
...
from movieNight.gui.controller import generate_movies, add_remove_movie
