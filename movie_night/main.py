...
from movie_night.utils       import apply_dark_palette
from movie_night.settings    import ICON, ACCENT_COLOR, DATABASE_PATH
from movie_night.gui.main_window import MainWindow
from movie_night.gui.controller   import update_data 
...
class UpdateWorker(QObject):
    ...
    @Slot()
    def run(self) -> None:
        from movie_night.metadata import movie_night_db
