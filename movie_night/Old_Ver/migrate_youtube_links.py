...
# ------------------------------------------------------------------ paths
OLD_DB = pathlib.Path("/mnt/d/Code/Movie_Night/movie_night/1st_movie_night.sqlite")
NEW_DB = pathlib.Path("/mnt/d/Code/Movie_Night/movie_night/movie_night.sqlite")
