...
from movie_night.metadata.analytics.scoring import calculate_combined_score, calculate_actor_trend_score
from movie_night.utils import locate_trailer
from movie_night.metadata import (
    repo, tmdb_client, omdb_client, trend_client, trend_client)
from movie_night.metadata.api_clients.errors import rate_limit_reached #Not defined yet
from movie_night.metadata.analytics.fairness import (
    Baselines, gtrend_fair, actor_trend_fair, combined_score_fair)
from movie_night.metadata.identity.fingerprint import same_movie, _NORMALIZERS

# ─────────────────────────  0 ▸ baselines  ──────────────────────────
# Build once at module-import time
BASE = Baselines(
    pop_by_country    = repo.population_share_by_country(),
    movies_by_country = repo.population_share_by_country(),
)
