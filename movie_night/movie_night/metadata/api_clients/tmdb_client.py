...
from movie_night.utils import log_debug, normalize, throttle
from movie_night.settings import TMDB_API_KEY
from movie_night.metadata.movie_night_db     import connection
from movie_night.metadata import international_reference
...
class TMDBClient:
    ...
    # Construction
    # ------------------------------------------------------------------
    def __init__(self, db: movie_nightDB, api_key: str | None = None):
        self.db = db
