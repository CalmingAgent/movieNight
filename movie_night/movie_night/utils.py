...
from movie_night.settings import LOG_PATH, ACCENT_COLOR
...
def locate_trailer( title: str) -> Tuple[str | None, str, float]:
    ...
    *sheet* is accepted for backward-compatibility but ignored; DB now
    ...
    """
    from movie_night.metadata.api_clients import tmdb_client, yt_client
    from movie_night.metadata.core import repo
    # 0. DB cache -------------------------------------------------------------
