...
from movie_night.settings       import ICON
from movie_night.gui.picker_page     import PickerPage
from movie_night.gui.stat_page       import StatsPage
from movie_night.gui.controller      import (
    generate_movies,
